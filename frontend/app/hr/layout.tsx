...
const navigationItems = [
  ...
  { name: 'Timesheets', href: '/hr/timesheets', icon: Clock },
  { name: 'Expenses', href: '/hr/expenses/dashboard', icon: Receipt },
  { name: 'Exit Management', href: '/hr/exit-management', icon: UserMinus },
  { name: 'Performance', href: '/hr/performance', icon: Award },
  { name: 'Learning', href: '/hr/learning', icon: GraduationCap },
  { name: 'Goals', href: '/hr/goals', icon: Target },
  { name: 'Reports', href: '/hr/reports', icon: BarChart3 },
];

const quickActions = [
  { icon: UserPlus, label: 'Invite Employee', color: 'text-blue-600', action: '/hr/invite-employee' },
  { icon: Upload, label: 'Bulk Invite', color: 'text-purple-600', action: '/hr/bulk-invite' },
  { icon: ClipboardCheck, label: 'Review Onboarding', color: 'text-green-600', action: '/hr/onboarding' },
  { icon: Calendar, label: 'Approve Leave', color: 'text-orange-600', action: '/hr/leave-requests' },
  { icon: Clock, label: 'Timesheet Analytics', color: 'text-cyan-600', action: '/hr/timesheets/dashboard' },
  { icon: Receipt, label: 'Expense Analytics', color: 'text-emerald-600', action: '/hr/expenses/dashboard' },
  { icon: UserMinus, label: 'Exit Requests', color: 'text-red-600', action: '/hr/exit-management' },
  { icon: BarChart3, label: 'Generate Report', color: 'text-indigo-600', action: '/hr/reports' },
  { icon: Award, label: 'Performance Reviews', color: 'text-violet-600', action: '/hr/performance' },
  { icon: MessageSquare, label: 'Employee Feedback', color: 'text-pink-600', action: 'coming-soon' },
];
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">HR Panel</p>
              </div>
            </div>
          </div>
