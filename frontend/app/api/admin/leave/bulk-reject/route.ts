...
// POST /api/admin/leave/bulk-reject - Bulk reject leave requests (Admin)
export async function POST(request: NextRequest) {
  try {
    ...
    // Verify authorization - managers and admins can only reject their direct reports' requests
